...
def tricky_method(a_string_param, an_array_param)
  ...
  return a_string_param, an_array_param # returns an array containing these two elements
end

my_string = "pumpkins"
my_array = ["pumpkins"]

my_string, my_array = tricky_method(my_string, my_array) #multiple assignment
